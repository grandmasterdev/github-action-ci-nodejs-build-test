...
// src/build-and-test.ts
var import_core = __toESM(require_core());
var import_exec = __toESM(require_exec());
var buildTest = () =>
  __async(void 0, null, function* () {
    try {
      yield (0, import_exec.exec)("npm", ["ci"]);
      yield (0, import_exec.exec)("npm", ["run", "build"]);
      yield (0, import_exec.exec)("npm", ["run", "test"]);
    } catch (ex) {
      (0, import_core.setOutput)("build-and-test-status", false);
    } finally {
      (0, import_core.setOutput)("build-and-test-status", true);
    }
  });
